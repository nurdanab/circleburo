  ...
  return (
    <section id="quiz" className="quiz-section bg-black text-white py-20 px-4 relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          className="text-lg md:text-xl text-white mb-20 text-center"
        ...
        <div className="quiz-content relative min-h-[400px] mt-8">
          {!isStarted ? (
            ...
            >
              ...
              >
                <div className="inline-block px-4 py-2 bg-white/10 border border-white/20 rounded-full text-sm uppercase tracking-widest text-white backdrop-blur-sm mb-4">
